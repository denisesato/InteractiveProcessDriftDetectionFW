...
info_ipdd = [
    dbc.CardBody(
        [
            ...
            html.P(dbc.CardLink("CONCEPT DRIFT DETECTION IN PROCESS MODELS - THESIS",
                                href="https://www.ppgia.pucpr.br/pt/arquivos/doutorado/teses/2022"
                                     "/Tese_Denise_Maria_Vecino_Sato.pdf",
                                target="_blank")),
